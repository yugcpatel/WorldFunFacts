        ...
        <div className="docs-container">
            ...
            <section>
                ...
                <p>
                    ...
                    When a country is selected, the app displays real-time information from the REST Countries API along with community-submitted fun facts stored in MongoDB. 
                    Users can add, delete, and upvote facts through a custom Express backend. The app also integrates Google's Gemini AI to instantly generate fun facts about any country. 
                    With a responsive search system, smooth animations, and a clean UI, the project provides an engaging way to learn about the world.
                </p>
            </section>
